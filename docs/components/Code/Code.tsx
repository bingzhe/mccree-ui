...
import { Button, Input, Box, th } from "../../../components/index";
...
const Code: React.FunctionComponent<CodeProps> = (props) => {
    ...
    const curCode = children.props.children;
    console.log("curCode", typeof (curCode));

    const [code, setCode] = React.useState(curCode);
